...
Данный проект представляет собой полный шаблон асинхронного CRUD с аунтефикацией. Проект использует **Python >=3.10**, новейшие версии [FastAPI](https://fastapi.tiangolo.com/), [Alembic](https://alembic.sqlalchemy.org/en/latest/) и [SQLModel](https://docs.sqlalchemy.org/en/20/) в качестве ORM.

За основу взят [шаблон](https://github.com/jonra1993/fastapi-alembic-sqlmodel-async/tree/main)
